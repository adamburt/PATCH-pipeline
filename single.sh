...
fastqc ${output_fastq_files}/${uuid}.fq --outdir ${output_fastq_files}
...
java -jar ${trimmomatic_jar_file} SE -threads 6 -phred33 \
${output_fastq_files}/${uuid}.fq \
${output_fastq_files}/${uuid}_trimmed.fq \
...
rnaspades -s ${output_fastq_files}/${uuid}_unmapped_sorted.fq --only-assembler -o ${spades_output_folder}/${uuid}
