...
kraken2_db_dir="/scratch/files/kraken"
kraken_directory="/scratch/processed_data/kraken"
centrifuge_dir="/scratch/processed_data/centrifuge"
centrifuge_db_dir="/scratch/files/centrifuge"
...
grch38_index_folder="/scratch/files/hisat/index"
